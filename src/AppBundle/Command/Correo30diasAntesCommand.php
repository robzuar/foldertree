...
class Correo30diasAntesCommand extends ContainerAwareCommand
{
    /**
    ...
    protected function configure()
    {
        $this
            ...
            ->setName('correo:aviso30dias')
            ->setDescription('Correos de avisos 30 dias antes');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($entities) {
            ...
            $logmail = new Logmail($user, 'correo30dias', 'Sin movimiento');
            $em->persist($logmail);
            $em->flush();
        }
    }
