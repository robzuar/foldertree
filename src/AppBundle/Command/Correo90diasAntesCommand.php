...
class Correo90diasAntesCommand extends ContainerAwareCommand
{
    /**
    ...
    protected function configure()
    {
        $this
            ...
            ->setName('correo:aviso90dias')
            ->setDescription('Correos de avisos 90 dias antes');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($entities) {
            ...
            $logmail = new Logmail($user, 'correo90dias', 'Sin movimiento');
            $em->persist($logmail);
            $em->flush();
        }
    }
