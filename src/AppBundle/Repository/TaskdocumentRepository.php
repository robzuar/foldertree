...
class TaskdocumentRepository extends EntityRepository
{
    ...
    public function getDocByProject($proyecto)
    {
        ...
        return $query
            ->select('doc','task','checkers','checkerus', 'assistents', 'assistentus')
            ...
            ->leftJoin('checkers.checker', 'checkerus')
            ->leftJoin('assistents.assistent', 'assistentus')
    ...
    public function getTaskByProject($proyecto)
    {
        ...
        return $query
            ->select('task','checkers', 'assistents','doc')
